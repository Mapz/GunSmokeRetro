...
namespace UnityEngine.Tilemaps {
    ...
    public class GridInformation : MonoBehaviour, ISerializationCallbackReceiver {
        [Serializable]
        public struct GridInformationValue {
            public GridInformationType type;
            public object data;
        }

        [Serializable]
        public struct GridInformationKey {
        ...
        public Dictionary<GridInformationKey, GridInformationValue> PositionProperties {
        ...
        public bool SetPositionProperty (Vector3Int position, String name, GridInformationType dataType, System.Object positionProperty) {
            Grid grid = GetComponentInParent<Grid> ();
